...
-- Insertar valores en la tabla prediccion_fin_mundo los valores de eventos_apocalipticos de manera automática
...
-- Agrupar los eventos por década y calcular el promedio de días restantes, el número de eventos que empiezan por D y el número de eventos que empiezan por A
SELECT
